...
c$$$      
c$$$c$$$      CALL rdfous_ring(filename,.FALSE.,nfou,nmat,nmugs,xmu,rfou)
c$$$c$$$      DO i=1,nmugs*nmat
c$$$c$$$         DO j=1,nmugs
c$$$c$$$            DO m=0,nfou-1
c$$$c$$$               write(*,*) i,j,m,rfou(i,j,m)
...
c$$$c$$$      STOP
c$$$      
c$$$      phi(1)=1.490116119384765625e-08
c$$$      beta(1)=0.000000000000000000e+00
c$$$      theta0(1)=4.999999999999998890e-01
...
c$$$
c$$$      WRITE(*,*) "What is expected:"
c$$$      WRITE(*,*) 6.193646058775441171e-06,-3.046132218287162406e-07,
c$$$     .          -9.759550180589223642e-15,4.918156751904256135e-02
c$$$      
c$$$c$$$* Expected: 4.59785742e-07, 2.25122997e-07, 1.83440080e-09, 4.89642131e-01
...
*======================================================================
     ...
     .     Sarr(NPIX_,NMAT_+1)
      ...
      CALL rdfous_ring(filename,.TRUE.,nfou,nmat,nmugs,xmu,rfou)

      DO i=1,nmugs*nmat
         DO j=1,nmugs
            DO m=0,nfou-1
               write(*,*) i,j,m,rfou(i,j,m)
            ENDDO
         ENDDO
      ENDDO
      STOP
      
      phi(1)=1.601029385538801364e+00
      beta(1)=1.601029385538801364e+00
      theta0(1)=1.744974835125044643e-02
     ...
     .     apix,Sarr)
      ...
      WRITE(*,*) 1.688771016436214060e-07,-1.485273114913191718e-08,
     .          2.674513729889046925e-09,8.936444506313186154e-02
